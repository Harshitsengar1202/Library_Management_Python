...
db=connct.connect("admin.db")
dd=connct.connect("storebook.db")
dc=connct.connect("students.db")
...
class maincode:
     ...
     def login(self):
         ...
         cur=db.cursor()
         cur.execute("SELECT * FROM adm WHERE User_ID='"+self.var1+"' and Password='"+self.var2+"'")
         db.commit()
         self.ab = cur.fetchall()
         if self.ab!=None:
             ...
             self.lb3=Label(self.fm2,text='Library Management System',fg='White',bg='#0f624c',font=('Arial',30,'bold'))
             self.lb3.place(x=200,y=17)


             #----------------------------name------------------------

             self.name=Label(root,text="Librarian's Name : ",bg='#fff',fg="black",font=('Arial',10,'bold'))
             self.name.place(x=5,y=83)
             #self.name1=Label(root,text=self.ab[0],fg='black',bg='#fff',font=('Arial',10,'bold'))
     ...
     def cur(self):
             ...
             self.lb1_hr = Label(self.fm3, text='12:', font=('times new roman', 10, 'bold'), bg='white', fg='black')
             self.lb1_hr.place(x=770, y=0, width=20, height=15)


             self.lb3_hr = Label(self.fm3, text='05:', font=('times new roman', 10, 'bold'), bg='white', fg='black')
             self.lb3_hr.place(x=790, y=0, width=20, height=15)


             self.lb5_hr = Label(self.fm3, text='37', font=('times new roman', 10, 'bold'), bg='white', fg='black')
             self.lb5_hr.place(x=810, y=0, width=20, height=15)


             self.lb7_hr = Label(self.fm3, text='AM', font=('times new roman', 8, 'bold'), bg='white', fg='black')
             self.lb7_hr.place(x=830, y=0, width=20, height=15)
             ...
             self.photo9=PhotoImage(file="C:\\Users\\vikas\\Downloads\\programs\\Library management System GUI\\Library management System GUI\\bb.png")
             self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)

             #self.develop=Label(self.fm3,text='Developed By - Gautam Sharma and Group',bg='#fff',fg='blue',
             #                  font=('Cursive',12,'italic','bold'))
             #self.develop.place(x=550,y=350)
          ...
          #-------------------------About Button------------------
             self.bt10=Button(self.fm3,text='About',fg='#fff',bg='#ff0076',font=('Arial',15,'bold'),width=170,
                          height=0,bd=7,relief='flat',cursor='hand2',command=self.about)
             self.bt10.place(x=550,y=350)
             self.log10 = PhotoImage(file='ezgif.com-gif-maker.gif')
...
Yha p daal dena teri mrji se sooch k""")
     ...
     def issuebook(self):
         class test(maincode):
              ...
              def mail(self):
                    ...
                    self.var=cursor.fetchone()
                    sender = "harshit.sengar1202@gmail.com"
                    reciever =self.var[5]
                    password="Harshit1202"
                    ...
                    try:
                        ...
                        print("ok")
                        messagebox.showinfo("Library System","Sent mail Successfully !")
                    except:
                         pass
         obk=test()
         obk.issue()
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def code(self):
         ...
         self.photo=PhotoImage(file="C:\\Users\\vikas\\Downloads\\programs\\Library management System GUI\\Library management System GUI\\images (17).png")
         ...
         self.photo1=PhotoImage(file="C:\\Users\\vikas\\Downloads\\programs\\Library management System GUI\\Library management System GUI\\dd.png")
     ...
     def chan_pas(self):
         ...
         self.b=self.e2.get()
         import sqlite3
         conn=sqlite3.connect(host="localhost",user="root", passwd="mysystem", database="admin")
         cursor=conn.cursor()
